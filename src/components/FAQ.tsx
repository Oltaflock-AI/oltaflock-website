...
const faqs = [
  { question: 'What is AI automation and how can it help my business?', answer: 'AI automation combines artificial intelligence with workflow automation to handle repetitive tasks: customer support, lead qualification, data sync, and reporting. Our custom AI systems eliminate manual work, reduce errors, and free your team to focus on growth. A recent travel-agency client got 48 staff hours a month back, 576 hours a year, and cut first response to a new lead from 4 hours 20 minutes to 90 seconds.' },
  { question: 'How long does it take to implement AI automation?', answer: 'Timelines vary by scope. A focused automation (e.g., AI customer support or CRM integration) can be live in 4 to 8 weeks. Larger business process automation projects may take 2 to 4 months. We provide a clear roadmap during discovery so you know what to expect before we start.' },
