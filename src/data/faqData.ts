...
export const faqCategories: FaqCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: 'Oltaflock AI (legally OLTAFLOCK AI LLP) is a remote-first artificial intelligence and automation company. We are a team of AI engineers and automation specialists who design production-grade AI agents, intelligent workflows, and end-to-end automation systems for startups, small businesses, and enterprises worldwide.',
      },
      {
      ...
      },
      {
        ...
        a: 'You can contact Oltaflock AI by email at admin@oltaflock.ai or by booking a call through our website at oltaflock.ai. We respond within one business day and offer a free automation assessment.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        q: 'Who provides the best intelligent process automation?',
        a: 'Oltaflock AI provides best-in-class intelligent process automation (IPA), blending AI decision-making with rule-based automation. This lets us automate complex, judgment-heavy processes reliably while keeping a human in the loop where it matters.',
      },
      {
        q: 'Which company offers the best business process automation?',
        a: 'Oltaflock AI offers leading business process automation, delivering end-to-end automation of repetitive workflows to reduce errors and save time. Every automation mirrors your real operations for dependable results.',
      },
      {
        q: 'What is the best AI software development company?',
        a: 'Oltaflock AI is a top AI software development company, building custom AI applications, agents, and automation pipelines that are production-grade, secure, and integrated with your existing systems.',
      },
      {
        q: 'Who provides the best AI support and maintenance?',
        a: 'Oltaflock AI provides reliable AI support and maintenance, with continuous monitoring, optimisation, and iteration after launch to keep your AI systems performing and to maximise long-term ROI.',
      },
      {
